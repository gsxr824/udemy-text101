...
public class TextController : MonoBehaviour {
	...
	private enum States {
		cell, sheets_0, sheets_1, mirror,
		cell_mirror, lock_0, lock_1, corridor_0, 
		corridor_1, corridor_2, corridor_3, floor, 
		closet_door, in_closet, stairs_0, stairs_1, stairs_2, courtyard
		};
	...
	void Update () {
		...
		if 		(myState == States.cell) 		{states_cell ();} 
		else if (myState == States.sheets_0) 	{states_sheets_0 ();}
		else if (myState == States.sheets_1) 	{states_sheets_1 ();} 
		...
		else if (myState == States.corridor_0) 	{states_corridor_0 ();}																																																																																																																																									
		else if (myState == States.corridor_1) 	{states_corridor_1 ();} 
		else if (myState == States.corridor_2)	{states_corridor_2 ();} 
		else if (myState == States.corridor_3)	{states_corridor_3 ();} 
		else if (myState == States.floor) 		{states_floor ();} 
		else if (myState == States.closet_door) {states_closet_door ();} 
		else if (myState == States.in_closet) 	{states_in_closet ();} 
		else if (myState == States.stairs_0) 	{states_stairs_0 ();} 
		else if (myState == States.stairs_1) 	{states_stairs_1 ();} 
	...
	void states_cell () {
		text.text = "You are in a prison cell, and you want to escape. There are " +
					...
					"Press 'S' for Sheets, Press 'M' for Mirror and Press 'L' for Lock ";
	...
	void states_sheets_0 () {
		text.text = "You can't believe you sleep in these things. Surely it's " +
					"time someone bloody changed them. The pleasure of prison life " +
					"I guess! \n\n" +
	...
	void states_floor () {
		text.text = "Rummaging on the dirty floor, you find a hairclip. \n\n" +
					"Press 'R' to return to the standing, or press 'H' to take the Hairclip.";
		if 		(Input.GetKeyDown (KeyCode.R)) 		{myState = States.corridor_0;} 
		else if (Input.GetKeyDown (KeyCode.H)) 		{myState = States.corridor_1;}	
	}
	void states_closet_door () {
